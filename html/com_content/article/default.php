...
// Verificando a existência de alertas a serem disparados 
    if(isset($_SESSION["error"]) && isset($_SESSION["msg_to_display"])):
			JFactory::getApplication()->enqueueMessage($_SESSION["msg_to_display"], 'error');
			unset($_SESSION["msg_to_display"]);
			unset($_SESSION["error"]);
		endif;
		
		if(isset($_SESSION["success"]) && isset($_SESSION["msg_to_display"])):
			JFactory::getApplication()->enqueueMessage($_SESSION["msg_to_display"], 'success');
			unset($_SESSION["msg_to_display"]);
